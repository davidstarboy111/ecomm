                                    ...
                                    <div class="product">
                                        <div class="product_img">
                                            <a href="shop-product-detail.html">
                                                <img src="/productFolder/{{ $prd->productImage }}" alt="product_img1" 
                                                style="width: 100%; height: 230px; object-fit: cover; object-position: top;"> 
                                            </a>

                                        </div>
                                        <div class="product_info">
                                            <h6 class="product_title"><a href="{{ route
                                            ('product_details', $prd->id) }}">{{ $prd->productName }}</a></h6>
                                            <div class="product_price">
                                                @if($prd->discountPrice != null)
                                                <span class="price">${{ number_format
                                                ($prd->discountPrice) }}</span>
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <p style="margin-bottom: 0px;">{{ $prd->quantity }}</p>
                                                <span ></span>
                                            </div>
                                        </div>
                                    </div>
